...
public enum Interaction {
	...
	UPDATE_INJECTION_STATUS_DB("UpdateInjectionStatusToDB"),
	SET_NO_INJECTION_STATUS_DB("SetNoInjectionStatusToDB"),
	UPDATE_INJECTION_REMARK_DB("UpdateInjectionRemarkToDB"),
